...
Source0: ftp://ftp.gnu.org/non-gnu/cvs/source/feature/%{version}/cvs-%{version}.tar.bz2
Source1: cvs.xinetd
Source2: cvs.pam
Source3: cvs.sh
Source4: cvs.csh
...
# notation from ls(1)
Patch23: cvs-1.12.13-sanity.patch
# Run tests verbosely
Patch24: cvs-1.12.13-make_make_check_sanity_testing_verbose.patch
# bug #722972
Patch27: cvs-1.12.13-Allow-CVS-server-to-use-any-Kerberos-key-with-cvs-se.patch
# CVE-2012-0804, bug #787683
Patch28: cvs-1.12.13-Fix-proxy-response-parser.patch
...
Patch31: cvs-1.12.13-need-gettext-version-el6.patch
...
%configure --with-external-zlib CFLAGS="$CFLAGS $RPM_OPT_FLAGS \
...
%changelog
* Thu Apr 12 2019 Kazuhito Ishigaki <ishigaki@jtrustsystem.co.jp> - 1.12.13-3jts
